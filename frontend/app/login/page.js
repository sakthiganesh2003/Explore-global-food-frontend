      ...
      <div class="shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] max-w-6xl max-md:max-w-lg rounded-md p-6">
        ...
        <div class="grid md:grid-cols-2 items-center gap-8">
          <div class="max-md:order-1">
            <img src="explore.png" class="w-full aspect-[12/11] object-contain" alt="login-image" />
          </div>
          ...
          <form class="md:max-w-md w-full mx-auto">
            ...
            <div class="mt-12">
              <button type="button" class="w-full shadow-xl py-2.5 px-4 text-sm font-semibold tracking-wide rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                Sign in
              </button>
