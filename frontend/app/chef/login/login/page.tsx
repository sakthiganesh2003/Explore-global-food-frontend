...
const SignInComponent = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/auth/chef/login`, {
        method: "POST",
      ...
      const fallbackMsg = err instanceof Error ? err.message : "Something went wrong";
    ...
    <div className="min-h-screen bg-cover bg-center text-gray-900 flex items-center justify-center bg-indigo-950 p-6">
      <div className="w-full max-w-md bg-zinc-300 bg-opacity-80 backdrop-blur-lg rounded-2xl shadow-xl p-8 md:p-12">
        <div className="text-center mb-8">
          ...
          />
          <h2 className="text-xl md:text-2xl font-bold text-gray-800">Chef Signin</h2>
